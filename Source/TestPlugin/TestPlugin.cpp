// TestPlugin.cpp : Defines the class behaviors for the application.
//
...
/////////////////////////////////////////////////////////////////////////////
// CTestPluginApp initialization

BOOL CTestPluginApp::InitInstance()
{
	AfxEnableControlContainer();

	m_pWorkSpace =	new CPluginWorkspace;
	if(!m_pWorkSpace) return FALSE;
	if(!m_pWorkSpace->InitialPluginEnv()) 
	{
		delete m_pWorkSpace;
		m_pWorkSpace=NULL;
		return FALSE;
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CTestPluginDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CTestPluginView));
...
void CTestPluginApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
/////////////////////////////////////////////////////////////////////////////
// CTestPluginApp message handlers
